...
export default function Footer() {
  return (
    <footer className="relative z-20 bg-black border-t border-white/[0.06] py-10 px-8 max-sm:px-6">
      <div className="max-w-5xl mx-auto flex items-center justify-between max-sm:flex-col max-sm:gap-6">
        {/* Location */}
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            aria-label="LinkedIn"
            className="text-[#b0ada8] hover:text-[#f0eeea] transition-colors"
          >
