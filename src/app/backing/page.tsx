            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-12 gap-y-14 max-sm:gap-y-10">
              {[
                ...
                <div key={item.label} className="border-l-2 border-white/30 pl-6">
                  ...
                  <p className="font-serif font-light text-[2.4rem] text-white tracking-[-0.02em] mb-2 max-sm:text-[1.8rem]">
                    {item.value}
                  </p>
                  <p className="font-sans font-light text-[0.85rem] text-white/60 leading-[1.6]">
                    {item.detail}
                  </p>
                </div>
              ))}
