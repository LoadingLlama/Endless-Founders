  ...
  return (
    <div className="bg-black min-h-screen flex items-center justify-center px-8 max-sm:px-5 py-16">
      <main className="max-w-xl w-full">
        ...
        <p className="font-sans font-light text-[0.85rem] text-[#b5b3ae] mb-2 max-sm:text-[0.9rem]">june – mid/end july · cohort I</p>
        <p className="font-sans font-light text-[0.85rem] text-[#807d78] mb-12 max-sm:text-[0.85rem]">currently only open to applicants based in the united states.</p>
